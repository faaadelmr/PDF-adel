  ...
  return (
    <div>
        <div className="flex flex-wrap gap-3 justify-start items-center mb-6">
            ...
            <Button onClick={handleDownloadMerged} size="sm" disabled={isProcessing || splitPoints.size > 0}>{isProcessing ? <Loader2 className="mr-2 animate-spin"/> : <Download className="mr-2"/>}Unduh Terpilih</Button>
            <Button onClick={handleDownloadSplit} variant="outline" size="sm" disabled={isProcessing || selectedPages.size === 0}>{isProcessing ? <Loader2 className="mr-2 animate-spin"/> : <Scissors className="mr-2"/>}Unduh Split PDF</Button>
